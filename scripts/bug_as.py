...
def planning(goal):
    ...
    feedback = assignment2_rt_part1.msg.PlanningFeedback()
    result = assignment2_rt_part1.msg.PlanningResult()
...
def main():
    ...
    act_s = actionlib.SimpleActionServer('/reaching_goal', assignment2_rt_part1.msg.PlanningAction, planning, auto_start=False)
    act_s.start()
